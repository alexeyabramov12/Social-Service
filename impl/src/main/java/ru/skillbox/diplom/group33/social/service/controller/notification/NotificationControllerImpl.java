...
public class NotificationControllerImpl implements NotificationController {
    ...
    @Override
    public ResponseEntity<NotificationDto> addNotifications(NotificationInputDto notificationInput) {
        return ResponseEntity.ok(notificationService.addNotification(notificationInput));
    }
